...
let stories = new Zuck("stories", {
  ...
  stories: [
    ...
    Zuck.buildTimelineItem(
      ...
      // Story photo src
      "/static/images/post/1by1/02.jpg",
      ...
      [
        ...
        ["user1-story1", "photo", 5, "/static/images/albums/01.jpg", "", '', false, false, timestamp()],
        ["user1-story2", "video", 0, "/static/images/videos/video-call.mp4", "", '', false, false, timestamp()],
        ["user1-story3", "photo", 5, "/static/images/albums/02.jpg", "", 'https://stackbros.in', 'Visit my Portfolio', false, timestamp()]
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-2",
      "/static/images/post/1by1/03.jpg",
      "Billy Vasquez",
      "",
      timestamp(),
      [
        ["user2-story1", "photo", 5, "/static/images/albums/03.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-3",
      "/static/images/post/1by1/04.jpg",
      "Amanda Reed",
      "",
      timestamp(),
      [
        ["user3-story1", "photo", 5, "/static/images/albums/04.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-4",
      "/static/images/post/1by1/05.jpg",
      "Lori Stevens",
      "",
      timestamp(),
      [
        ["user4-story1", "photo", 5, "/static/images/albums/05.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-5",
      "/static/images/post/1by1/06.jpg",
      "Samuel Bishop",
      "",
      timestamp(),
      [
        ["user5-story1", "photo", 5, "/static/images/albums/06.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    Zuck.buildTimelineItem(
      "user-6",
      "/static/images/post/1by1/07.jpg",
      "Joan Wallace",
      "",
      timestamp(),
      [
        ["user6-story1", "photo", 5, "/static/images/albums/06.jpg", "", '', false, false, timestamp()],
      ]
    ),
    ...
    {
      id: "user-7",               // story id
      photo: "/static/images/albums/05.jpg",            // story photo (or user photo)
      ...
      items: [              // array of items
        // Story item 
        {
          ...
          src: "/static/images/albums/05.jpg",      // photo or video src
